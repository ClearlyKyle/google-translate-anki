	...
	*/
	...
	var Xh = function (a) {
		...
		if (a.query)
			if (a.Ob) {
				...
				/* ANKI BUTTON */
				b += '</select><button class="btnAnki" style="margin-left:10px">ANKI</button></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' +
	...
	Jj.prototype.a = function (a, b, c, d) {
		if (null != d) {
			...
			/* ANKI BUTTON function */
			xc(c.getElementsByClassName("btnAnki")[0], 'click', function (e) {
				//var target = getElementsByClassName("gtx-target");

				var target = c.getElementsByClassName("gtx-target")[0];
				var to = target.innerText;
				var from = target.getAttribute('data-source');
				...
				chrome.storage.local.get(['ankiDeckNameSel', 'ankiModelNameSel', 'ankiFieldSentence', 'ankiFieldTranslation', 'ankiFieldWord'],
					({ ankiDeckNameSel, ankiModelNameSel, ankiFieldSentence, ankiFieldTranslation, ankiFieldWord, ankiConnectUrl }) => {
